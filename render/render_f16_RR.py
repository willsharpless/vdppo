...
def draw_targets(ax, setting_type='RR',alpha=0.5, draw_obstacles=True):
    ...
    if setting_type == 'RR':
        ...
        for ti, target in enumerate(targets):
            ...
            add_sphere(ax, target, radius=radius, resolution=30, alpha=alpha/2, color=color)
...
if __name__ == "__main__":
    ...
    setting_type='RR'
    file_name = f"render/figs/f16_{setting_type}_render_test_{setting_type}.png"
