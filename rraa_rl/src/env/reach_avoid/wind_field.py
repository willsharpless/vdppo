...
data_1 = jnp.load("./rraa_rl/src/env/wind_field_1.npz")
data_2 = jnp.load("./rraa_rl/src/env/wind_field_2.npz")
...
class WindField(environment.Environment):
    ...
    def step_env(
        ...
        next_energy = jnp.clip(state.energy - jnp.sum(control ** 2) / 2., params.min_energy, params.max_energy)
