...
from rraa_rl.src.rl.baselines.MORL_PPO_RR import sparse_replace_rr, morl_replace_rr
from rraa_rl.src.rl.utils.eval_all_RR_utils import test_RR, plot_scores_RR
...
if __name__ == "__main__":
    ...
    score_plot = plot_scores_RR(traj_batches, config, title="SafetyGym-RR")
