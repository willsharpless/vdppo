...
class Transition_raa_respo(NamedTuple):
    done: jnp.ndarray
    action: jnp.ndarray
    value: jnp.ndarray
...
class Transition_rr_respo(NamedTuple):
    done: jnp.ndarray
    action: jnp.ndarray
    value: jnp.ndarray
    value_prob: jnp.ndarray
...
class Transition_rcppo_adapted_raa(NamedTuple):
    done: jnp.ndarray
    action: jnp.ndarray
    value: jnp.ndarray
    value_reach: jnp.ndarray
...
class Transition_rcppo_adapted_rr(NamedTuple):
    done: jnp.ndarray
    action: jnp.ndarray
    value: jnp.ndarray
    value_reach: jnp.ndarray
