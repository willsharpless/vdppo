...
for NOISE_PERCENT in 0.0 5.0 10.0 20.0; do
    python ./rraa_rl/src/rl/RR-PPO.py \
    --EXP_NAME=HalfCheetahReachReach \
    --DIR=NOISY_halfcheetah_rr_rg_noisy_nz${NOISE_PERCENT} \
    --LR=3e-4 \
    --NUM_ENVS=128 \
    --NUM_STEPS=400 \
    ...
    --NAME=NOISY_halfcheetah_rr_rg_noisy_nz${NOISE_PERCENT}
done
...
for NOISE_PERCENT in 0.0 5.0 10.0 20.0; do
    ...
    --DIR=NOISY_halfcheetah_rr_dstl_noisy_nz${NOISE_PERCENT} \
    --LR=3e-4 \
    --NUM_ENVS=128 \
    --NUM_STEPS=400 \
    --TOTAL_TIMESTEPS=150_000_000 \
    ...
    --NOISE_PERCENT=${NOISE_PERCENT} \
    --WANDB_PROJECT=RR-HalfCheetah-noise \
    --NAME=NOISY_halfcheetah_rr_dstl_noisy_nz${NOISE_PERCENT}
done
