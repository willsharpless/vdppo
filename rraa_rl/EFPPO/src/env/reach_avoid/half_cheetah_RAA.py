...
class HalfCheetahReachAvoid:
    ...
    def step(self, key, state, action, params=None):
        ...
        done = False # always true to encourage always avoid
    ...
    @partial(jax.jit, static_argnums=(0,))
    def is_avoid_old(self, poses): # OLD fix
        (head_pos, neck_pos, back_pos, front_thigh_pos, front_shin_pos,
...
class HalfCheetahAvoidOnly:
    ...
    ## TANH Verison
    # @partial(jax.jit, static_argnums=(0,))
    # def is_avoid_old(self, head_pos, front_thigh_pos, front_shin_pos, front_foot_pos, back_thigh_pos, back_shin_pos, back_foot_pos):
    #     box_height, box_halfwidth, box_ycenter, box_front_xcenter, box_back_xcenter = 0.05, 0.25, -0.7, 4.5, 6.5
    #     alpha = 2.
