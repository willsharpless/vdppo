...
def get_env(config):
    ...
    elif config["EXP_NAME"] == "HopperReachAlwaysAvoid_CPPO" or config["EXP_NAME"] == "HopperReachAlwaysAvoid_RCPPO" or \
        config["EXP_NAME"] == "HopperReachAlwaysAvoidBaseline_MORL" or config["EXP_NAME"] == "HopperReachAlwaysAvoidBaseline_Sparse":
        obs_dim = 12 + 1
    ...
    elif config["EXP_NAME"] == "HopperReachReach_sum_CPPO" or config["EXP_NAME"] == "HopperReachReach_sum_RCPPO" or \
        config["EXP_NAME"] == "HopperReachReachBaseline_MORL" or config["EXP_NAME"] == "HopperReachReachBaseline_Sparse":
        obs_dim = 12 + 2
        vec1 = jnp.zeros(obs_dim, dtype=jnp.float32)
        vec1 = vec1.at[0].set(1.)
        vec2 = jnp.ones(obs_dim, dtype=jnp.float32)
