...
def plot_scores(traj_batches, config):
    ...
    axes[0].set_title(r"SafetyGym-RR: Success Percentage ($\uparrow$)", fontsize=12)
    ...
    axes[1].set_title(r"SafetyGym-RR: Mean Steps to Success ($\downarrow$)", fontsize=12)
    ...
    axes[2].set_title(r"SafetyGym-RR: Maximum Value ($\uparrow$)", fontsize=12)
    ...
    # axes[0].set_xlim(0.7, 1.0)
    axes[3].set_title(r"SafetyGym-RR: Reached One Percentage ($\uparrow$)", fontsize=12)
...
if __name__ == "__main__":
    ...
    if debug:
        ...
        config["DIR_HJPPO"]="BASELINE_point_rr"
        config["DIR_MODEL_HJPPO"]="best_270"
        # config["DIR_MODEL_HJPPO"]="checkpoint_487"

        config["DIR_CPPOv1"]="BASELINE_point_rr_cppo"
        config["DIR_MODEL_CPPOv1"]="checkpoint_487"

        config["DIR_CPPOv2"]="BASELINE_point_rr_cppo"
        config["DIR_MODEL_CPPOv2"]="checkpoint_487"

        config["DIR_CPPOv3"]="BASELINE_point_rr_cppo"
        config["DIR_MODEL_CPPOv3"]="checkpoint_487"

        config["DIR_DSTL"]="BASELINE_point_rr_decomposed"
        config["DIR_MODEL_DSTL"]="best_61"

        config["DIR_PPOLAG"]="BASELINE_point_rr_ppolag_lam0p01"
        config["DIR_MODEL_PPOLAG"]="best_469"

        config["DIR_PPO"]="BASELINE_point_rr_ppo"
        config["DIR_MODEL_PPO"]="best_339"

        config["DIR_RCPPO"]="BASELINE_point_rr_rcppo"
        config["DIR_MODEL_RCPPO"]="best_117"

        config["DIR_RESPO"]="BASELINE_point_rr_respo"
        config["DIR_MODEL_RESPO"]="best_45"

        config["DIR_MORL"]="BASELINE_point_rr_morl"
        config["DIR_MODEL_MORL"]="checkpoint_486"

        config["DIR_SPARSE"]="BASELINE_point_rr_sparse"
        config["DIR_MODEL_SPARSE"]="checkpoint_486"

        config["DIR_P2BPO"]="BASELINE_point_rr_p2bpo"
        config["DIR_MODEL_P2BPO"]="best_416"

        config["DIR_LOGBAR"]="BASELINE_point_rr_logbar"
        config["DIR_MODEL_LOGBAR"]="best_18"

        config['TEST_DIR'] = "eval_all_rebuttal"
        config['NAME_TAG'] = "Point_RR_080625"
    ...
    config_CPPOv1["EXP_NAME"] = "PointReachReach_CPPO"
    ...
    config_CPPOv2["EXP_NAME"] = "PointReachReach_CPPO"
    ...
    config_CPPOv3["EXP_NAME"] = "PointReachReach_CPPO"
    ...
    config_dSTL["EXP_NAME"] = "PointReachReachDecomposed"
    env_dSTL, env_dSTL_1, env_dSTL_2 = get_env(config_dSTL)

    ## PPO LAG
    config_PPOLAG = copy.deepcopy(config)
    config_PPOLAG["EXP_NAME"] = "PointReachReach_CPPO"
    ...
    config_PPO["EXP_NAME"] = "PointReachReach_CPPO"
    ...
    config_RCPPO["EXP_NAME"] = "PointReachReach_RCPPO"
    ...
    config_RESPO["EXP_NAME"] = "PointReachReach_RESPO" 
    ...
    config_MORL["EXP_NAME"] = "PointReachReach_MORL"
    ...
    config_SPARSE["EXP_NAME"] = "PointReachReach_Sparse"
    ...
    config_P2BPO["EXP_NAME"] = "PointReachReachBaseline_P2BPO"
    ...
    config_LOGBAR["EXP_NAME"] = "PointReachReach_CPPO"
