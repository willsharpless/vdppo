...
def plot_scores(traj_batches, config):
    ...
    axes[0].set_xlim(0, 1.)
    axes[0].set_title(r"SafetyGym-RAA: Success Percentage ($\uparrow$)", fontsize=12)
    ...
    axes[1].set_title(r"SafetyGym-RAA: Mean Steps to Success ($\downarrow$)", fontsize=12)
    ...
    axes[2].set_title(r"SafetyGym-RAA: Maximum Value ($\uparrow$)", fontsize=12)
    ...
    axes[3].set_title(r"SafetyGym-RAA: Reached or Avoided Percentage ($\uparrow$)", fontsize=12)
...
if __name__ == "__main__":
    ...
    if debug:
        ...
        config["DIR_RESPO"]="BASELINE_point_raa_respo"
        ...
        config["DIR_P2BPO"]="BASELINE_point_raa_p2bpo"
        config["DIR_MODEL_P2BPO"]="best_171"
    ...
    config_CPPO["EXP_NAME"] = "PointReachAlwaysAvoid_CPPO"
    ...
    config_RA["EXP_NAME"] = "PointReachAvoid"
    env_RA = get_env(config_RA)

    ## PPO LAG
    config_PPOLAG = copy.deepcopy(config)
    config_PPOLAG["EXP_NAME"] = "PointReachAlwaysAvoid_CPPO"
    ...
    config_PPO["EXP_NAME"] = "PointReachAlwaysAvoid_CPPO"
    ...
    config_RCPPO["EXP_NAME"] = "PointReachAlwaysAvoid_CPPO"
    ...
    config_RESPO["EXP_NAME"] = "PointReachAlwaysAvoid_CPPO" #"HopperReachReach_sum_RESPO"
    ...
    config_MORL["EXP_NAME"] = "PointReachAlwaysAvoid_MORL"
    ...
    config_SPARSE["EXP_NAME"] = "PointReachAlwaysAvoid_Sparse"
    ...
    config_P2BPO["EXP_NAME"] = "PointReachAlwaysAvoidBaseline_P2BPO"
    ...
    config_LOGBAR["EXP_NAME"] = "PointReachAlwaysAvoid_CPPO"
