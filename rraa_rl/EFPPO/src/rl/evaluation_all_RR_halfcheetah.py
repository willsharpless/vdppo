...
def plot_scores(traj_batches, config):
    ...
    axes[0].set_title(r"HalfCheetah-RR: Success Percentage ($\uparrow$)", fontsize=12)
    ...
    axes[1].set_title(r"HalfCheetah-RR: Mean Steps to Success ($\downarrow$)", fontsize=12)
    ...
    axes[2].set_title(r"HalfCheetah-RR: Maximum Value ($\uparrow$)", fontsize=12)
    ...
    # axes[0].set_xlim(0.7, 1.0)
    axes[3].set_title(r"HalfCheetah-RR: Reached One Percentage ($\uparrow$)", fontsize=12)
...
if __name__ == "__main__":
    ...
    if debug:
        ...
        # config["DIR_PPOLAG"]="BASELINE_halfcheetah_reachreach_ppolag"
        # config["DIR_MODEL_PPOLAG"]="best_XX"

        # config["DIR_PPO"]="BASELINE_halfcheetah_reachreach_ppo"
        # config["DIR_MODEL_PPO"]="best_XX"

        # config["DIR_RCPPO"]="BASELINE_halfcheetah_reachreach_rcppo"
        # config["DIR_MODEL_RCPPO"]="best_XX"

        # config["DIR_RESPO"]="BASELINE_halfcheetah_reachreach_respo"
        # config["DIR_MODEL_RESPO"]="best_XX"

        # config["DIR_MORL"]="BASELINE_halfcheetah_reachreach_morl"
        # config["DIR_MODEL_MORL"]="best_XX"

        # config["DIR_SPARSE"]="BASELINE_halfcheetah_reachreach_sparse"
        ...
        config["DIR_P2BPO"]="BASELINE_halfcheetah_rr_p2bpo"
        config["DIR_MODEL_P2BPO"]="checkpoint_730"
    ...
    # "BASELINE_final_halfcheetah_rr_cppomax_raccum_cfnmax_caccum_umin_V1--LR=3e-4"
    config_CPPOv1 = copy.deepcopy(config)
    config_CPPOv1["EXP_NAME"] = "HalfCheetahReachReach_CPPO"
    ...
    # "BASELINE_final_halfcheetah_rr_cpposum_raccum_cfnmax_caccum_umin_V1"
    config_CPPOv2 = copy.deepcopy(config)
    config_CPPOv2["EXP_NAME"] = "HalfCheetahReachReach_CPPO"
    ...
    # "BASELINE_final_halfcheetah_rr_cpposum_raccum_cfnsum_caccum_umean_V2"
    config_CPPOv3 = copy.deepcopy(config)
    config_CPPOv3["EXP_NAME"] = "HalfCheetahReachReach_CPPO"
    ...
    config_PPOLAG["EXP_NAME"] = "HalfCheetahReachReach_CPPO"
    ...
    config_PPO["EXP_NAME"] = "HalfCheetahReachReach_CPPO"
    ...
    config_RCPPO["EXP_NAME"] = "HalfCheetahReachReach_RCPPO"
    ...
    config_RESPO["EXP_NAME"] = "HalfCheetahReachReach_RESPO" 
    ...
    config_MORL["EXP_NAME"] = "HalfCheetahReachReachBaseline_MORL"
    ...
    config_SPARSE["EXP_NAME"] = "HalfCheetahReachReachBaseline_Sparse"
    ...
    config_P2BPO["EXP_NAME"] = "HalfCheetahReachReachBaseline_P2BPO"
    ...
    config_LOGBAR["EXP_NAME"] = "HalfCheetahReachReach_CPPO"
